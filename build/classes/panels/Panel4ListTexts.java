 ...
 */
public class Panel4ListTexts extends Panel4 {

  private static JPanel jp;
  private static JFrame jf;
  private int tabs;
  private static Panel4ListText[] tab;
   ...
   */
  public Panel4ListTexts() {
    initComponents();
    tabs = (int) jSpinner1.getValue();
    tab = new Panel4ListText[tabs];
    for (int i = 0; i < tabs; i++) {
      tab[i] = new Panel4ListText();
