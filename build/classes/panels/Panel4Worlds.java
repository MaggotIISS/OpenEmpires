 ...
 */
public class Panel4Worlds extends Panel4 {

  private static Panel4 jp;
  private static Frame4 jf;
  private int tabs;
  private static Panel4World[] tab;
  ...
  public Panel4Worlds() {
    ...
    tab = new Panel4World[tabs];
    for (int i = 0; i < tabs; i++) {
      tab[i] = new Panel4World();
      jtp.addTab("World " + (i + 1), tab[i]);
    }
  }
