 ...
 */
public class Panel4T5SystemPic extends Panel4 {
  ...
  public Panel4T5SystemPic() {
    super();
    initComponents();
    DefaultComboBoxModel cbm = new DefaultComboBoxModel();
    String[][] str = new String[4][20];
...
//    drawStar();
  ...
  private void initComponents() {
    ...
    jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "F7 V", "BD", "M6 D" }));
