...
public class AreaRegion extends Region {
  ...
  public final void setContentBias(Orientation value) {
    contentBiasProperty().set(value);
  }
  ...
  public final void setSurfaceArea(double value) {
    surfaceAreaProperty().set(value);
  }

  public final double getSurfaceArea() {
    return surfaceArea == null ? 64000.0 : surfaceArea.get();
  }
