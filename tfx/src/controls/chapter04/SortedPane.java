...
public class SortedPane extends Pane {
  ...
  protected void layoutChildren() {
    ...
    Collections.sort(sortedChildren, (c1, c2) -> new Double(c1.prefWidth(-1))
      .compareTo(new Double(c2.prefWidth(-1))));
    ...
    for (Node c : sortedChildren) {
      ...
      layoutInArea(c, currentX, getInsets().getTop(), width, height, 0,
  ...
  protected double computePrefWidth(double height) {
    ...
    return getInsets().getLeft() + getInsets().getRight() + width
      + cumulatedSpacing;
  }
