...
public class TextInputDemo extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    caretRightLabel.setOnMouseEntered((e) -> caretRightLabel.setTextFill(
      Color.ORANGE));
    caretRightLabel.setOnMouseExited((e) -> caretRightLabel.setTextFill(
      Color.BLUE));
    ...
    caretStartLabel.setOnMouseEntered((e) -> caretStartLabel.setTextFill(
      Color.ORANGE));
    caretStartLabel.setOnMouseExited((e) -> caretStartLabel.setTextFill(
      Color.BLUE));
    ...
    caretEndLabel.setOnMouseEntered((e) -> caretEndLabel.setTextFill(
      Color.ORANGE));
    ...
    wrapLabel.setOnMouseClicked((e) -> textArea.setWrapText(!textArea
      .isWrapText()));

    HBox menu = new HBox(caretStartLabel, caretLeftLabel, wrapLabel,
      caretRightLabel, caretEndLabel);
    menu.setSpacing(12);
