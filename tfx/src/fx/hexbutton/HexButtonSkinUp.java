...
public class HexButtonSkinUp extends SkinBase<HexButton> {
  ...
  protected HexButtonSkinUp(HexButton hexButton) {
    super(hexButton);
  ...
  private final InvalidationListener invalidHexListener = observable
    -> invalidHex = true;
  private ScaleTransition scaleTransition;
  private StyleableObjectProperty<Duration> scaleTransitionTime;
  private final InvalidationListener updateEffectListener = observable
    -> updateEffect();
  private final InvalidationListener updateHexColorListener = observable
    -> updateHexColor();
  ...
  public StyleableObjectProperty<Duration> scaleTransitionTimeProperty() {
    if (scaleTransitionTime == null) {
      scaleTransitionTime = CssHelper.createProperty(
        StyleableProperties.SCALE_TRANSITION_TIME, HexButtonSkinUp.this);
    }
