...
public class CssHelper {
  ...
  public static <S extends Styleable, V> StyleableObjectProperty<V> createProperty(
    ...
    return new SimpleStyleableObjectProperty<V>(metaData, styleable, metaData
      .getPropertyName(), metaData.getInitialValue(styleable));
  }
  ...
  public static <S extends Control, V> StyleableObjectProperty<V> createProperty(
    ...
    return new SimpleStyleableObjectProperty<V>(metaData, skin, metaData
      .getPropertyName(), metaData.getInitialValue(skin.getSkinnable()));
  }

  public static <S extends Styleable, V> DefaultPropertyBasedCssMetaData<S, V> createMetaData(
    String property, StyleConverter<?, V> converter, String propertyName,
    V defaultValue) {
    return new DefaultPropertyBasedCssMetaData<S, V>(property, converter,
