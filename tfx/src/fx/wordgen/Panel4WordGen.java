...
import static fx.wordgen.GlobalVariables.FS;
...
public class Panel4WordGen extends javax.swing.JPanel {
  ...
  public static wordgen.Panel4Grid6x6[] p4gs;
...
//    jTextArea2.append(getWord() + CRLF);
  ...
  public static String getWord(MouseEvent evt) {
    ...
    return Panel4WordGen.jTextArea2.getText().trim();
  }

  public static String getWord(MouseEvent evt, String arg) {
    Panel4WordGen panel4WordGen = new Panel4WordGen();
...
//        f = new File(T5 + FS + "WordGen/src/wordgen/imp-villang.csv");
        f = new File("C:/T5/TFX/src/fx/wordgen/imp-villang.csv");
      }
      lines = loadLines(f);
      int l = lines.length;
