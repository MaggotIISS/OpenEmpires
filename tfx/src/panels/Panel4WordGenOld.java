...
/**
 ...
 @author maggot
 */
public class Panel4WordGenOld extends javax.swing.JPanel {
  ...
  static panels.Panel4Grid6x6[] p4gs;
  static panels.Panel4Grid6x6 p4g;
  static String lang;
  static int n = 0;
  static int num = 0;
...
//    System.out.println("syll" + " = " + syll);
   ...
   */
  public Panel4WordGenOld() {
    setName("Panel4WordGen");
    initComponents();
    p4gs = new panels.Panel4Grid6x6[]{
      panel4Grid6x61,
      panel4Grid6x62,
      panel4Grid6x63,
      panel4Grid6x64,
...
//    jTextArea2.append(getWord() + CRLF);
  ...
  public static String[] loadLines(File f1) {
    lines = null;
    if (f.isFile()) {
      lines = dbviewer.globals.GlobalMethods.getLinesFromFile(f);
    }
    return lines;
  }

  public static String getWord(MouseEvent evt) {
    Panel4WordGenOld panel4WordGen = new Panel4WordGenOld();
  ...
  private static void setTables(String[] args) {
    ...
    for (k = 0; k < langs.length; k++) {
      f = new File(langs[k]);
      if (args.length == 0) {
        f = new File(T5 + FS + "WordGen/src/panels/imp-villang.csv");
      }
      lines = loadLines(f);
      int l = lines.length;
...
//    System.out.println("loadParts(" + lines + ");");
    ...
    for (int i = 0; i < lines.length; i++) {
      tmp = dbviewer.globals.GlobalMethods.stripCSV(lines[i]);
...
//          //System.out.print(string);
  ...
  private void initComponents() {
    ...
    panel4Grid6x61 = new panels.Panel4Grid6x6();
    ...
    panel4Grid6x62 = new panels.Panel4Grid6x6();
    jPanel7 = new javax.swing.JPanel();
    panel4Grid6x63 = new panels.Panel4Grid6x6();
    jPanel8 = new javax.swing.JPanel();
    panel4Grid6x64 = new panels.Panel4Grid6x6();
    jPanel9 = new javax.swing.JPanel();
    panel4Grid6x65 = new panels.Panel4Grid6x6();
...
//    }
  ...
  private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
    jTextArea2.append(dbviewer.globals.GlobalMethods.capWords(getSyll(evt, 0)));
  }//GEN-LAST:event_jLabel1MouseClicked

  private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
    jTextArea2.append(dbviewer.globals.GlobalMethods.capWords(getSyll(evt, 1)));
...
//    System.out.println("syll" + " = " + syll);
  ...
  private panels.Panel4Grid6x6 panel4Grid6x61;
  private panels.Panel4Grid6x6 panel4Grid6x62;
  private panels.Panel4Grid6x6 panel4Grid6x63;
  private panels.Panel4Grid6x6 panel4Grid6x64;
  private panels.Panel4Grid6x6 panel4Grid6x65;
