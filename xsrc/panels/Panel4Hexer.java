...
public class Panel4Hexer extends Panel4 {
//---------------------------
...
//---------------------------
  ...
  private static JSpinner jsl = new JSpinner(
    new SpinnerNumberModel(1, 1, 100, 1));
  private static JLabel rot = new JLabel("V");
  private static boolean rota = false;
...
//---------------------------
  ...
  public Panel4Hexer() {
    ...
    cp.setLayout(new GridLayout(1, 8));
    add(cp, "North");
    GlobalMethods.autoColor(cp, Color.black, Color.LIGHT_GRAY);
    JPanel hp = new HexPanel();
    add(hp, "Center");
    SouthPanel sp = new SouthPanel();
    add(sp, "South");
    sp.setLayout(new GridLayout(1, 8));
    JScrollPane jsp = new JScrollPane(hp);
    setToolTipText("PAN");
    add(cp, "North");
    add(sp, "South");
    add(jsp, "Center");
    setVisible(true);
    GlobalMethods.autoColor(jp, Color.black, Color.LIGHT_GRAY);
  }
...
//
      ...
      rot.addMouseListener(new MouseAdapter() {
        ...
        private void rotate(boolean rota) {
    ...
    public class ChangeListenerImpl implements ChangeListener {
      ...
      /**
       <p>
       @param ce ChangeEvent to occur
       */
      @Override
      public void stateChanged(ChangeEvent ce) {
        setupNumbers();
        SouthPanel.showBools();
      }
    }
    ...
    private void setupNumbers() {
      ...
      HexPanel.resizePanel(jp);
      //SouthPanel.
//      jf.setTitle("" + jf.getSize());
//      SouthPanel.getS().setText(jf.getSize().toString());
    }
  }
//---------------------------
  ...
  /**
   HexPanel
   */
  public static class HexPanel extends Panel4 {
    ...
    public HexPanel() {
      ...
      addComponentListener(new ComponentAdapter() {
        @Override
        public void componentResized(ComponentEvent e) {
          //System.out.print("Resize" + " = " + super.getClass());
          //System.out.print("" + " = " + super.toString());
          HexPanel.resizePanel(HexPanel.this);
        }
      });
    }

    private static void addPoly(boolean rota) {
      ...
      if (rota) {
        ...
        poly.addPoint((int) (L + 0), (int) (T + L3));
        poly.addPoint((int) (L + L4), (int) T);
        poly.addPoint((int) (L + (L4 * 2)), (int) (T + L3));
        poly.addPoint((int) (L + (L4 * 2)), (int) (T + L3 + L5));
        poly.addPoint((int) (L + L4), (int) (T + (L3 * 2) + L5));
        poly.addPoint((int) (L + 0), (int) (T + L3 + L5));
      }
    }

    /**
     <p>
     @param pan JPanel to resize
     */
    public static void resizePanel(JPanel pan) {
//      //System.out.print("pan.getSize()" + " = " + pan.getSize());
//      int PanX = pan.getX();
//      //System.out.print("PanX" + " = " + PanX);
//      int PanY = pan.getY();
//      //System.out.print("PanY" + " = " + PanY);
//      int wid = (int) (H * 11 / 8);
//      //System.out.print("wid" + " = " + wid);
//      int hgt = (int) H;
//      //System.out.print("hgt" + " = " + hgt);
//      int w = wid * (int) jsy.getValue();
//      //System.out.print("w" + " = " + w);
//      int h = hgt * (int) jsx.getValue();
//      //System.out.print("h" + " = " + h);
//      //System.out.print(" = = = = = = = = = = = = = ");
//      //s.setTitle(""+pan.getSize());
//      pan.setPreferredSize(new Dimension(width, height));
    ...
    private void drawPoly(Graphics g) {
      ...
      int l;
      int t;
      l = (int) (L + ((int) jsh.getValue() * 1 / 8));
      t = (int) T;
      //g.setColor(Color.cyan);
      //g.drawOval(l,0,(int)jsh.getValue()*9/8,(int)jsh.getValue()-1);
      g.drawOval(l, t, (int) jsh.getValue() * 9 / 8, (int) jsh.getValue());
      g.setColor(Color.white);
      g.fillOval(l, t, (int) jsh.getValue() * 9 / 8, (int) jsh.getValue());
...
//1      poly.addPoint((int) (L + L3), (int) T);
          ...
          if (DIAG3) {
            ...
            g.drawLine((int) (L + L3), (int) T, (int) (L + L3 + (int) L5),
              (int) (T + (L4 * 2)));
            //2,5
            g.drawLine((int) (L + L3 + L5), (int) T, (int) (L + L3),
              (int) (T + (L4 * 2)));
            //3,6
          ...
          if (FILE) {
            File file = new File(
              "D:/CYBERBOARD/BMP/Har/Cra/CM=50-ModularCutter-10.gif");
            try {
              image = ImageIO.read(file);
            } catch (IOException ex) {
            }
            g.drawImage(image,
              (int) (L + L3 + (L5 / 2)) - (image.getWidth() / 2),
              (int) (T + L4) - (image.getHeight() / 2), null);
          }
          //</editor-fold>
//---------------------------
...
//---------------------------
  ...
  public static class HexPrinter implements ActionListener, Printable {
    ...
    /**
     @param ae ActionEvent to perform
     */
    @Override
    ...
    /**
     ...
     @param pf     PageFormat
     @param i      number of pages
     @return whether could print or not
     @throws PrinterException fuck up
     */
    @Override
...
//---------------------------
  ...
  public static class SouthPanel extends JPanel {
    ...
    public SouthPanel() {
      ...
      add(jl3);
      //----------------------------------
//      s = new JLabel("s");//+pan.getPreferredSize());
//      add(s);
      add(printButton);
      printButton.setToolTipText("printButton=PRINT TO PRINTER");
      printButton.addActionListener(new HexPrinter());
...
//      return s.getText();
//    }
//    public static void setS(String txt) {
//      s.setText(txt);
//    }
...
//      Panel4Hexer.jf.setSize(width * 12 / 10, height + 100);
    }
  }
//---------------------------
}
